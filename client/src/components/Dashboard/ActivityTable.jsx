...
const ActivityTable = ({ data }) => {
  ...
  return (
    <div className="bg-white rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.02)] overflow-hidden" ref={menuRef}>
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="bg-gray-100">
              <th className="px-8 py-5 text-sm font-black text-gray-900 uppercase tracking-widest">Time</th>
              ...
              <th className="px-8 py-5 text-sm font-black text-gray-900 uppercase tracking-widest text-right">Options</th>
            </tr>
          </thead>
                  ...
                  <AnimatePresence>
                    {activeMenu === index && (
                      <motion.div
                        ...
                        className="absolute right-8 top-full mt-2 w-48 bg-white border border-gray-100 rounded-2xl shadow-2xl z-50 p-2 overflow-hidden"
                      >
